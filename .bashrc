...
alias 'commits-full'='git-commits-full'
alias cote='~/var/cote'
...
alias 'files-full'='git-files-full'
alias 'find?'='echo "find -name '\''*.R'\'' -exec wc -L {} \;"'
alias foxit='/opt/foxit/1.1/FoxitReader'
alias g='gwenview'
alias 'git-commits'='git log --abbrev-commit --format=oneline origin/master..master'
alias 'git-commits-full'='git log --abbrev-commit --format="$GIT_FORMAT" origin/master..master'
...
alias t='emacs *.tex'
alias taf='Rscript --vanilla -e "icesTAF::sourceAll()"'
alias tag='git tag'
